...
version: 2.2.0
*/
// YAHOO     YAHOO.util.Dom     YAHOO.util.Event
...
return r;}}};}();Array.prototype.show=function(){YAHOO.util.Dom.setStyle(this,'display','');};Array.prototype.toggle=function(){YAHOO.util.Dom.batch(this,function(el){el.style.display=el.style.display!='none'?'none':'';});};Ext.query=Ext.DomQuery.select;YAHOO.util.Dom.query=Ext.query;